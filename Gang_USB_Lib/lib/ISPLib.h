...
DLL_EXPORT  unsigned int ISP_Read(io_handle_t* handle, unsigned char* pcBuffer,
                                  unsigned int szMaxLen, unsigned int dwMilliseconds, unsigned char* bNum, unsigned char* ext);
DLL_EXPORT  unsigned int ISP_Write(io_handle_t* handle, unsigned char uCmd, unsigned char bext,
...
DLL_EXPORT  unsigned int Erase_APROM(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                     unsigned short pcount, unsigned int staddr);
DLL_EXPORT  unsigned int Write_APROM(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                     unsigned short dcount, unsigned int staddr, unsigned char data[]);
DLL_EXPORT  unsigned int Read_APROM(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                    unsigned short dcount, unsigned int staddr, unsigned char data[]);
DLL_EXPORT  unsigned long long int Get_Version(io_handle_t* handle, unsigned char bsel,
        unsigned char bext, unsigned char* Num, unsigned char* ext);
DLL_EXPORT  unsigned long long int Get_Boot(io_handle_t* handle, unsigned char bsel,
        unsigned char bext, unsigned char* Num, unsigned char* ext);
DLL_EXPORT  unsigned int Jump_Code(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                   unsigned char boot_select);
DLL_EXPORT  unsigned long long int Read_Reg(io_handle_t* handle, unsigned char bsel,
        unsigned char bext, unsigned char reg, unsigned char* Num, unsigned char* ext);
DLL_EXPORT  unsigned int Read_Info32(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                     unsigned char pagecnt, unsigned char offset, unsigned char data[], unsigned char* Num,
                                     unsigned char* ext);
DLL_EXPORT  unsigned int Write_Info32(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                      unsigned char pagecnt, unsigned char offset, unsigned char data[], unsigned char* Num,
                                      unsigned char* ext);
...
DLL_EXPORT  unsigned int ISP_Read_DataFlash(io_handle_t* handle, unsigned short dcount,
        unsigned int staddr, unsigned char data[]);
DLL_EXPORT  unsigned int ISP_Update_DataFlash(io_handle_t* handle, unsigned short dcount,
        unsigned int staddr, unsigned char data[]);

DLL_EXPORT  unsigned long long int Verify_APROM_Checksum(io_handle_t* handle, unsigned char bsel,
