...
unsigned int ISP_Read(io_handle_t* handle, unsigned char* pcBuffer, unsigned int szMaxLen,
                      unsigned int dwMilliseconds, unsigned char* bNum, unsigned char* ext)
{
...
unsigned int ISP_Write(io_handle_t* handle, unsigned char uCmd, unsigned char ext,
...
unsigned int ISP_Update_DataFlash(io_handle_t* handle, unsigned short dcount, unsigned int staddr,
                                  unsigned char data[])
{
    ...
    unsigned int ret = ISP_Write(handle, CMD_UPDATE_APROM, NULL, acBuffer, dcount + 6 + ex_of,
                                 USBCMD_TIMEOUT_LONG);
    ISP_Read(handle, NULL, 0, USBCMD_TIMEOUT_LONG, NULL, NULL);
    return ret;
}

unsigned int ISP_Read_DataFlash(io_handle_t* handle, unsigned short dcount, unsigned int staddr,
                                unsigned char data[])
{
...
unsigned int Erase_APROM(io_handle_t* handle, unsigned char bsel, unsigned char ext,
                         unsigned short pcount, unsigned int staddr)
{
...
unsigned int Write_APROM(io_handle_t* handle, unsigned char bsel, unsigned char ext,
                         unsigned short dcount, unsigned int staddr, unsigned char data[])
{
    unsigned char acBuffer[PACK_SIZE + 1];
    int ex_of = 0;
    if (dcount <= 250) {
    ...
    unsigned int ret = ISP_Write(handle, CMD_WRITE_HUB + bsel, ext, acBuffer, dcount + 6 + ex_of,
                                 I2CCMD_TIMEOUT);
    ISP_Read(handle, NULL, 0, I2CCMD_TIMEOUT, NULL, NULL);
    return ret;
}

unsigned int Read_APROM(io_handle_t* handle, unsigned char bsel, unsigned char ext,
                        unsigned short dcount, unsigned int staddr, unsigned char data[])
{
    unsigned int ret = FALSE;
...
unsigned long long int Get_Version(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                   unsigned char* Num, unsigned char* ext)
{
    unsigned int ret = FALSE;
...
unsigned long long int Get_Boot(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                unsigned char* Num, unsigned char* ext)
{
    unsigned int ret = FALSE;
...
unsigned int Jump_Code(io_handle_t* handle, unsigned char bsel, unsigned char bext,
...
unsigned long long int Read_Reg(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                                unsigned char reg, unsigned char* Num, unsigned char* ext)
{
    unsigned char acBuffer[1];
    acBuffer[0] = reg;
    unsigned int ret = FALSE;
...
unsigned int Read_Info32(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                         unsigned char pagecnt, unsigned char offset, unsigned char data[], unsigned char* Num,
                         unsigned char* ext)
{
...
unsigned int Write_Info32(io_handle_t* handle, unsigned char bsel, unsigned char bext,
                          unsigned char pagecnt, unsigned char offset, unsigned char data[], unsigned char* Num,
                          unsigned char* ext)
{
...
unsigned long long int Verify_APROM_Checksum(io_handle_t* handle, unsigned char bsel,
        unsigned char bext, unsigned long int crc32_checksum)
{
