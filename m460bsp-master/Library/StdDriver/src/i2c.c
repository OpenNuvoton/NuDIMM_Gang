...
uint32_t u32txLen_2[5] = {0u, 0u, 0u, 0u, 0u};
uint32_t* I2C_WriteMultiBytesOneReg_2(int i2c_num, int i2c_ext, I2C_T *i2c[], uint8_t u8SlaveAddr[], uint8_t u8DataAddr, uint8_t data[], uint32_t u32wLen)
{
...
uint32_t u32rxLen_2[5] = {0u, 0u, 0u, 0u, 0u};
